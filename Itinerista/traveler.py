...
def request():
    ...
    return render_template('traveler/view_request.html')
...
def itinerary():
    ...
    return render_template('traveler/view_itinerary.html')
...
def requests_history():
    ...
    return render_template('traveler/request_history.html')